...
const categories = ['All', 'Web Apps', 'Mobile Apps', 'E-Commerce', 'ERP Systems', 'Design'];
...
const projects = [
  {
    ...
    longDescription: 'Developed a comprehensive e-commerce solution for a major retail client, handling over 10,000 products and processing 5,000+ daily orders. The platform features real-time inventory tracking, multi-currency support, and advanced analytics dashboards.',
  ...
  },
  {
    ...
    longDescription: 'Built a comprehensive fitness application that helps users track their workouts, monitor nutrition, and achieve their health goals. Features include AI-powered workout recommendations, social sharing, and integration with popular wearables.',
  ...
  },
  {
    ...
    longDescription: 'Created a comprehensive brand identity for a tech startup, including logo design, color system, typography, and brand guidelines. The modern, minimalist design reflects the company\'s innovative approach and resonates with their target audience.',
    tech: ['Figma', 'Illustrator', 'Photoshop', 'After Effects'],
    results: ['Brand recognition up 200%', 'Featured in design awards', 'Positive market feedback'],
    link: '#',
  },
  {
    id: 4,
    ...
    longDescription: 'Developed a powerful SaaS dashboard that provides real-time insights into business metrics. Features include customizable widgets, advanced filtering, automated reports, and role-based access control.',
    tech: ['React', 'D3.js', 'Node.js', 'MongoDB', 'WebSocket'],
    results: ['2000+ active users', '40% faster decision-making', 'Enterprise clients secured'],
    link: '#',
  },
  {
    id: 5,
    ...
    longDescription: 'Conducted extensive UX research and created an intuitive UI design for a fintech application. The project involved user interviews, usability testing, and iterative design to create a seamless experience for managing finances.',
    tech: ['Figma', 'Sketch', 'Principle', 'UserTesting'],
    results: ['User satisfaction up 85%', 'Task completion time reduced 60%', 'Industry recognition'],
    link: '#',
  },
  {
    id: 6,
    ...
    longDescription: 'Created a seamless food ordering experience with features like real-time order tracking, multiple payment options, and loyalty rewards. The app serves multiple restaurant locations and handles thousands of orders daily.',
    tech: ['Flutter', 'Firebase', 'Google Maps API', 'Stripe'],
    results: ['30,000+ orders monthly', '25% increase in average order value', '95% customer satisfaction'],
    link: '#',
  },
  {
    id: 7,
    ...
    description: 'Enterprise resource planning system for manufacturing operations.',
    longDescription: 'Developed a comprehensive ERP system that streamlines manufacturing operations, from inventory management to production planning and quality control. The system integrates with existing hardware and provides real-time insights.',
    tech: ['Angular', 'Java Spring', 'Oracle DB', 'Docker'],
    results: ['30% efficiency improvement', '50% reduction in errors', 'ROI achieved in 8 months'],
    link: '#',
  },
  {
    id: 8,
    ...
    description: 'Patient portal with appointment scheduling and medical records.',
    longDescription: 'Built a HIPAA-compliant patient portal that allows patients to schedule appointments, access medical records, and communicate with healthcare providers securely. Features include telemedicine integration and prescription management.',
    tech: ['Vue.js', 'Laravel', 'MySQL', 'WebRTC'],
    results: ['10,000+ patients enrolled', '60% reduction in phone calls', 'HIPAA certified'],
    link: '#',
  },
  {
    id: 9,
    ...
    longDescription: 'Created a premium online shopping experience for a luxury fashion brand, featuring AR try-on technology, personalized recommendations, and a sophisticated checkout process. The platform handles high-resolution product imagery and video.',
    tech: ['Next.js', 'Shopify', 'Three.js', 'AWS'],
    results: ['45% conversion rate increase', '20% reduction in returns', 'Award-winning design'],
    link: '#',
  },
];
...
const caseStudies = [
  {
    client: 'TechCorp Inc.',
    industry: 'Technology',
    challenge: 'Needed to modernize their legacy system and improve user engagement',
  ...
  },
  {
    client: 'RetailMax',
    industry: 'Retail',
    challenge: 'Struggling with outdated e-commerce platform and low conversion rates',
    solution: 'Built a modern, mobile-first e-commerce platform with AI recommendations',
  ...
  },
  {
    client: 'HealthPlus',
    industry: 'Healthcare',
    challenge: 'Required a secure patient management system compliant with regulations',
    ...
    <main className="relative min-h-screen">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute w-96 h-96 bg-blue-500/20 rounded-full blur-3xl top-0 right-0 animate-pulse-slow" style={{ animationDelay: '2s' }} />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-foreground/70 max-w-3xl mx-auto leading-relaxed">
              Explore our latest projects and see how we turn ideas into reality. Each project represents
              our commitment to excellence and innovation in digital solutions.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg text-foreground/70 text-center max-w-2xl mx-auto mb-16">
              Deep dives into our most impactful projects and the results we achieved for our clients
            </p>
          ...
          >
            <Card className="p-12 glass-effect max-w-4xl mx-auto">
              ...
              <p className="text-lg text-foreground/70 mb-8">
                Let's collaborate to bring your vision to life and achieve remarkable results together.
              </p>
